...
class WatermarkDetector(WatermarkBase):
    ...
    * z_threshold -> Changing this threshold will change the sensitivity of the detector.
    ...
    def _predict_message(self, position_cnt, green_cnt_by_position, p_val_per_pos,
        ...
        random_prediction_list = [msg_prediction]
        # [vendoring patch] upstream assumes >= num_candidates message
        # positions; short payloads (e.g. 8 bits at radix 4 -> 4 positions)
        # crash with IndexError. Cap at the available positions. Affects only
        # the list-decoding candidate metrics, not the best prediction.
