...
class LMContext:
    def __init__(self, model_name: str):
        ...
        if getattr(self.model, "generation_config", None) is not None:
            ...
            # NUCLEUS FIX: hub checkpoints ship sampling defaults that
            # model.generate() silently merges with our kwargs (Llama-3.1
            # ships top_p=0.9), stacking a hidden warper on top of the
            # watermark processors. Log what shipped, then neutralize.
